...
// Prepare request.
String image = args.Length > 0 ? args[0] : "https://storage.googleapis.com/api4ai-static/samples/face-analyzer-2.jpg";
...
Console.WriteLine($"[i] Faces detected: {objects.Count()}");
